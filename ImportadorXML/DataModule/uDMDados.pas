...
type
  TDMDados = class(TDataModule)
    ...
    cdCTeNFNUMERO: TIntegerField;
    cdCTeNFSERIE: TStringField;
    cdCTeNFFILIAL: TIntegerField;
    cdCTeNFORIGEM: TStringField;
    cdCTeNFCLIFOR: TIntegerField;
    ...
    SQLQueryCTeNFNUMERO: TIntegerField;
    SQLQueryCTeNFSERIE: TStringField;
    SQLQueryCTeNFFILIAL: TIntegerField;
    SQLQueryCTeNFORIGEM: TStringField;
    SQLQueryCTeNFCLIFOR: TIntegerField;
    ...
    SQLQueryCTeNATUREZA: TStringField;
...
begin
  cdNFE.FieldByName('AUTORIZADA').AsString   := 'N';
